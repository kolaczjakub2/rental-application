...
import com.jkolacz.usermanagement.domain.user.UserAssertion;
import com.jkolacz.usermanagement.domain.user.UserExistingException;
...
class UserApplicationServiceTest {
    private static final String LOGIN = "jkolacz";
